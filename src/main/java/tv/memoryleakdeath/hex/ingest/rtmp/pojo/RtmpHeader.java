...
public class RtmpHeader implements Serializable {
    ...
    public String toString() {
        return "RtmpHeader [chunkStreamId=" + chunkStreamId + ", format=" + format + ", timestamp=" + timestamp + ", timestampDelta=" + timestampDelta + ", messageLength=" + messageLength
                + ", messageTypeId=" + messageTypeId + ", messageStreamId=" + messageStreamId + ", extendedTimestamp=" + extendedTimestamp + "]";
    }
}
